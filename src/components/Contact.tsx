...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "sureshkumar.mandali@waisl.in",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl p-8 text-white text-center"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="mailto:sureshkumar.mandali@waisl.in"
                className="bg-white text-emerald-600 px-8 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 inline-flex items-center justify-center"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="tel:+919949999015"
                className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-emerald-600 transition-all duration-300 inline-flex items-center justify-center"
              >
